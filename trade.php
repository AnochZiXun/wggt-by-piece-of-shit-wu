...
?>
				<div class="col-lg-10 table-responsive">
					...
					<form name="form" action="trade.php" method="post">
						<div class="form-group col-md-12">
							<div class="row">
								<div class="form-group col-md-6">
									<label>風利幣地址</label>
									<input type="text" name="my_wgc_address" value="" class="form-control" readonly> 
									
								</div>
								<div class="form-group col-md-6">
									<label>風利幣餘額</label>
									<input type="text" name="my_wgc" value=""  placeholder="" class="form-control" readonly> 
									<input type="hidden" name="wgc_coin" value="" />
								</div>
							</div>
						</div>
						<div class="form-group col-md-12">
							...
							<div class="row">
								<div class="form-group col-md-6">
									<input type="text" name="wgc_address" placeholder="風利幣收款地址" class="form-control">
								</div>
								<div class="form-group col-md-6">
									<input type="text" name="wgc"  placeholder="風利幣數量" class="form-control"> 
								</div>
								<input type="hidden" name="wgc_trade" />
							</div>
						</div>
